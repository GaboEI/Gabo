...
📌 Me llamo **Gabo**, y necesito un trato **cercano, profesional y claro**.  
...
6. **Clase JS 06 —** Bucles (`for`, `while`, `do...while`, `break`, `continue`).  
7. **Clase JS 07 —** Funciones: declaración, expresión, parámetros, retorno, `return`, hoisting.  
